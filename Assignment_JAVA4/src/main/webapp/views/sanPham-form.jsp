...
<header>
    <nav class="navbar navbar-expand-md navbar-dark"
        ...
        <div>
            <a href="<%=request.getContextPath()%>/sanPham/newSP" class="navbar-brand">Form thông tin</a>
        </div>

        <ul class="navbar-nav">
            <li><a href="<%=request.getContextPath()%>/sanPham/listSP"
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="updateSP" method="post">
                ...
                <c:if test="${todo == null}">
                <form action="insertSP" method="post">
                    </c:if>
